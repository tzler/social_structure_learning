...
class EyeLinkCoreGraphicsPsychoPy(pylink.EyeLinkCustomDisplay):
    def __init__(self, tracker, win):#
        ...
        sound_locations = os.getcwd() + '/audio_visual/'

        self.display = win
        self.__target_beep__ = sound.Sound(sound_locations + 'type.wav')
        self.__target_beep__done__ = sound.Sound(sound_locations + 'qbeep.wav')
        self.__target_beep__error__ = sound.Sound(sound_locations + 'error.wav')
